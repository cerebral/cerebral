...
exports[`Transform dot syntax from \`statePath\` to string should work for simple dot usage 1`] = `
"
\`hello.world\`;"
`;

exports[`Transform dot syntax from \`statePath\` to string should work with nested usage 1`] = `
"
\`hello.\${\`world\`}\`;"
`;

exports[`Transform dot syntax from \`statePath\` to string should work with other tags 1`] = `
"
