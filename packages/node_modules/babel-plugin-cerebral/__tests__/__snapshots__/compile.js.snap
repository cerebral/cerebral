...
exports[`Transform dot syntax to template tags should do nothing when import is not a tag name 1`] = `"import { wrongImport } from 'cerebral';"`;
...
exports[`Transform imports containing ".proxy" should not complain about other imports 1`] = `"import { state, foo, bar } from 'app.cerebral.proxy.ts';"`;
