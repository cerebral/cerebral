...
import { Controller, compute } from 'cerebral'
...
describe('Inferno', () => {
  ...
  describe('state container', () => {
    it('should be able to wrap app with container', () => {
      ...
      assert.ok(tree._lastInput.children instanceof TestComponent)
    })
  ...
  describe('container', () => {
      ...
      assert.throws(
        ...
        err => {
          if (err instanceof Error) {
            return (
              err.message ===
              'Cerebral - Can not find controller, did you remember to use the Container component? Read more at: http://cerebraljs.com/docs/api/components.html#inferno'
            )
          }
        }
      )
    ...
    it('should be able to unregister component from container after unmounting component', () => {
      ...
      assert.equal(tree._lastInput.children.view.isUnmounted, false)
      assert.equal($('div').innerHTML, 'bar')
      mount(null)
      assert.equal(tree._lastInput.children.view.isUnmounted, true)
      assert.deepEqual(
  ...
  describe('connect', () => {
    it('should convert component to json', () => {
      ...
      assert.equal(tree._lastInput.children.toJSON(), 'Test')
    })
    ...
    it('should rerender affected components', () => {
      ...
      const component = tree._lastInput.children._lastInput.children
