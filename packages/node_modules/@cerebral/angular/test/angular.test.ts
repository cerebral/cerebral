...
describe('Angular', () => {
  describe(`Component`, () => {
    ...
    before(() => {
      ...
      increaseFreqClick = fixture.debugElement.nativeElement.querySelector('#increaseFreq')
      changeSubCompNameClick = fixture.debugElement.nativeElement.querySelector('#changeSubCompName')
