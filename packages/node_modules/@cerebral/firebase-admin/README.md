...
### listUsers
Lists all users from Firebase authentication. Outputs {users: [], nextPageToken: 'token'}.
```js
...
### createUser
Create a user from Firebase. All properties are optional. Outputs {userRecord}.
```js
