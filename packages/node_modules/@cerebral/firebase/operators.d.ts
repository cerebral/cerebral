import { ContextualValue, Tag } from 'function-tree'

type Action = any

type TagOr<T> = ContextualValue<T> | T

export interface OnChildOptions {
  endAt?: TagOr<number>
  equalTo?: TagOr<number>
  limitToFirst?: TagOr<number>
  limitToLast?: TagOr<number>
  orderByChild?: TagOr<string>
  orderByKey?: TagOr<boolean>
  orderByValue?: TagOr<boolean>
  payload?: TagOr<any>
  startAt?: TagOr<number>
}
