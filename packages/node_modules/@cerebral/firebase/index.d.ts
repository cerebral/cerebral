export function FirebaseProvider(opts: any): any
...
export interface FirebaseProviderType {
  ...
  getUser(): UserPromise
  linkWithFacebook(options: { redirect?: boolean, scopes: string[] } & any): UserPromise
  ...
  put(path: string, file: any, opts?: PutOptions): Promise<{ url: string, filename: string }>
  ...
  signInWithFacebook(opts: { redirect?: boolean, scopes: string[] } & any): UserPromise
  ...
  transaction(path: string, transformer: TransformFunction): Promise<{ committed: any, value: any }>
