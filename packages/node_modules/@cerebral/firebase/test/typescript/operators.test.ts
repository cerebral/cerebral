...
const chain: Chain = [ 
  ...
  firebase.onChildChanged('some.fixed.path', signal`some.signal`, onChildOptions),
  firebase.onChildChanged('some.fixed.path', signal`some.signal`),
  firebase.onChildRemoved(props`some.dynamic.path`, signal`some.signal`, onChildOptions),
