...
function getComponentRef(Component) {
  ...
  const WrappedWithRef = (props) => {
    return <Component ref={ref => { componentRef = ref; }} {...props} />;
  };
...
describe('React', () => {
  describe('container', () => {
    ...
    it('should be able to unregister component from container after unmounting component', () => {
      ...
      const { WrappedWithRef, getRef } = getComponentRef(connect(
        {
          foo: state`foo`,
        },
        (props) => {
    ...
    it('should only rerender affected components', () => {
      ...
      class TestComponentClass extends React.Component {
        ...
        render() {
          ...
          return (
            <div>
              <button data-testid="action-button" onClick={() => this.callSignal()}>
                Action
              </button>
              <TestComponent2 />
            </div>
        ...
        render() {
          return (
            <span>
              ...
              <button data-testid="change-button" onClick={this.handlePathChange}>
                Change
              </button>
            </span>
          )
