...
export declare type Computed<T> = (state: any) => T;
...
export declare function Sequence<Context, Props, Output = Props>(arg: (props: SequenceBuilder<Context, Props>) => SequenceBuilder<Context, Output>): (props: Props) => Output;
