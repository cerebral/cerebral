...
export type SignalWithPayload<Props> = (props: Props) => void

export type Signal = (props?: void) => void

export { sequenceFactory, IContext, IContextWithPaths } from 'function-tree/fluent';
