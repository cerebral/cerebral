import { computed as mobxComputed, IComputedValue, observable, untracked, transaction, extras, ObservableMap as MobxObservableMap } from 'mobx';
...
export { SequenceFactory, SequenceWithPropsFactory, IContext, IContextWithPaths, IContextWithNoDataPaths } from 'function-tree/fluent';

export { ComputedValue, Computed } from './Computed';

export { default as Container } from './Container'

export type TDictionary<Type> = MobxObservableMap<Type>;
export function Dictionary<Type>(values: { [key: string]: Type }): MobxObservableMap<Type> {
