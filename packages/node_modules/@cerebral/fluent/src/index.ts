...
export function Sequence<Context, Props, Output = Props>(
	arg: (props: SequenceBuilder<Context, Props>) => SequenceBuilder<Context, TOutput>
): (props: Props) => Output {
...
class FluentController<State = {}, Signals = {}> extends BaseControllerClass {
	...
	constructor(rootModule: ModuleClass, options: ControllerOptions) {
		...
		this.signals = extractModuleProp(this.module, 'signals', (signals: ModuleSignals, module) => {
	...
	addModule(path: string, module: ModuleClass) {
		...
		updateIn(this.signals, pathArray.concat(moduleKey), (parentState: { [key: string]: any }, key: string) => {
			parentState[key] = Object.keys(newModule.signals).reduce((signals: ModuleSignals, key: string) => {
