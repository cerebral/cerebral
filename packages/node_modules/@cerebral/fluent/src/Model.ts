...
function CreateStateProvider(state: any, devtools: any, model: any) {
	if (!devtools && model.useLegacyStateApi) {
...
class Model extends BaseModel {
	constructor(controller: BaseControllerClass) {
		...
		this.StateProvider = (devtools: any) => CreateStateProvider(this.state, devtools, this);
	}
