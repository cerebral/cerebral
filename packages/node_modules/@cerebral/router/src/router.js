...
export default class Router {
  constructor(controller, addressbar, mapper, options) {
    ...
    controller.on('initialized', () => {
      ...
      this.routesBySignal = getRoutesBySignal(
        this.routesConfig,
  ...
  onUrlChange(event) {
    ...
    const prevSignal = (this.routesConfig[this.activeRoute.route] || {})
      .sequence
    if (
      sequence &&
      (prevSignal !== sequence ||
      ...
      sequence instanceof Tag
        ? sequence.getValue(this.controller.createContext())(payload)
        : this.controller.getSequence(sequence)(payload)
    }
  ...
  redirectToSignal(signalName, payload) {
    ...
    this.controller.getSequence(signalName)(payload)
  }
