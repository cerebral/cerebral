...
export default class Router {
  constructor(controller, addressbar, mapper, options) {
    ...
    controller.on('initialized', () => {
      ...
      this.attachGetSignalUrlMethods(this.routesBySignal, options.baseUrl)
  ...
  attachGetSignalUrlMethods(signals, baseUrl) {
    const signalPaths = Object.keys(signals)
    const mapper = this.mapper

    signalPaths.forEach(signalPath => {
      const signal = this.controller.getSignal(signalPath)

      signal.getSignalUrl = payload => {
        return baseUrl + mapper.stringify(signals[signalPath], payload || {})
      }
    })
  }
