...
describe('provider', () => {
  ...
  it('should expose `getUrl`', () => {
    ...
    controller.getSequence('test')({ param: 'something' })
  })
  ...
  it('should expose `getValues`', () => {
    ...
    controller.getSequence('test')({ page: 'foo', param: 'something' })
  })
  ...
  it('should expose `redirectToSignal`', (done) => {
    ...
    controller.getSequence('createClicked')()
  })
