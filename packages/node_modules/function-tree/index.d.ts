...
export abstract class ContextualValue<C={}, T=any> {
...
export interface Resolve {
  ...
  isContextualValue(arg: any): arg is ContextualValue

  path(tag: Tag): string
  value<T>(contextualValue: Tag<T> | T, overrideContext?: any): T
  value<T>(contextualValue: ContextualValue<{}, T> | T, overrideContext?: any): T
  value(contextualValue: ContextualValue, overrideContext?: any): any
}

// ========= Helpers

export function convertObjectWithTemplates<T=any>( object: any, resolve: Resolve ): T
...
export function resolveTemplates<T=any>(obj: any): ContextualValue<{}, T>
