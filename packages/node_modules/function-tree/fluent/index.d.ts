...
export interface IContext<TProps, TPaths = {}> {
    props: TProps;
    path: {
...
export interface IContextWithNoDataPaths<TProps, TPaths = {}> extends IContext<TProps> {
    path: {
...
export interface ISequenceBuilder<TContext, TProps> {
    ...
    pathsAction<TOutput, TPaths>(action: ((input: TContext & IContextWithNoDataPaths<TProps, TPaths>) => TOutput)) : {
...
export declare class SequenceBuilder<TContext = {}, TProps = {}> {
    ...
    pathsAction<TOutput, TPaths>(action: ((props: TContext & IContextWithNoDataPaths<TProps, TPaths>) => TOutput)) : { 
        paths: (paths: {
