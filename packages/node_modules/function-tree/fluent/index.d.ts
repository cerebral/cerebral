...
export interface ISequenceBuilder<TContext, TProps> {
    ...
    branch<TOutput, TPaths>(action: ((input: TContext & IBranchWithNoDataContext<TPaths, TProps>) => TOutput | Promise<TOutput>)) : {
...
export declare class SequenceBuilder<TContext = {}, TProps = {}> {
    ...
    branch<TOutput, TPaths>(action: ((props: TContext & IBranchWithNoDataContext<TPaths, TProps>) => TOutput | Promise<TOutput>)) : { 
        paths: (paths: {
    ...
    branch<TOutput, TPaths>(action: ((props: TContext & IBranchContext<TPaths, TProps>) => TOutput | Promise<TOutput>)): {
        paths: (paths: {
            [key in keyof TPaths]: (props: SequenceBuilder<TContext, TProps & TPaths[key]>) => SequenceBuilder<TContext, TProps & TPaths[key]>;
        }) => SequenceBuilder<TContext, TProps & TOutput>;
    };
