...
describe('primitives', () => {
  it('should correctly initiate primitive', () => {
    ...
    assert.deepStrictEqual(primitive.items, items)
    ...
    assert.deepStrictEqual(primitive.toJSON().items, items)
  })
  describe('sequence', () => {
    it('should have extended Primitive', () => {
      ...
      assert.deepStrictEqual(sequence.items, items)
      ...
      assert.deepStrictEqual(sequence.toJSON().items, items)
    })
  ...
  describe('parallel', () => {
    it('should have extended Primitive', () => {
      ...
      assert.deepStrictEqual(parallel.items, items)
      ...
      assert.deepStrictEqual(parallel.toJSON().items, items)
    })
