...
describe('StaticTree', () => {
  it('should create a static tree of an array', () => {
    ...
    const tree = staticTree([
      ...
      shortHandExamples.shortHand,
      shortHandExamples.asyncShortHand,
    ])
    ...
    assert.equal(tree.items[1].name, 'asyncTest')
    assert.equal(tree.items[2].name, 'shortHand')
    assert.equal(tree.items[3].name, 'asyncShortHand')
