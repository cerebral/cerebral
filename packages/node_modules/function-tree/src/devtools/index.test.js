...
describe('Devtools', () => {
  ...
  it('should work when debugger is already opened', (done) => {
    ...
    setTimeout(() => {
      assert.strictDeepEqual(messages, ['ping', 'init'])
  ...
  it('should add function tree', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.strictDeepEqual(devtools.trees[0], ft)
      assert.strictEqual(devtools.isConnected, true)
      mockServer.stop(done)
    }, 70)
  })
  ...
  it('should watch function tree executions', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.strictDeepEqual(Object.keys(messages), [
        'executionStart',
        'execution',
        'executionPathStart',
      ...
      assert.strictDeepEqual(messages.execution.data.execution.payload, {
        foo: 'bar',
      })
  ...
  it('should keep execution messages when debugger is not ready and send bulk messages after debugger is ready', (done) => {
    ...
    setTimeout(() => {
      assert.strictDeepEqual(Object.keys(messages), ['bulk'])
      ...
      assert.strictDeepEqual(executionMessage.data.execution.payload, { foo: 'bar' })
      ...
      assert.strictEqual(executionPathStartMessage.data.execution.path, 'success')
      ...
      assert.strictEqual(executionFunctionEndMessage.type, 'executionFunctionEnd')
      assert.ok(executionFunctionEndMessage.data.execution)
      assert.strictEqual(executionFunctionEndMessage.source, 'ft')
      assert.strictDeepEqual(executionFunctionEndMessage.data.execution.output, {
        bar: 'baz',
      })
  ...
  it('should send provider data', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.strictDeepEqual(messages.execution[1].data.execution.data.args, ['bar'])
