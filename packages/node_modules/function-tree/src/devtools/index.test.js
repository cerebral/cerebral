  ...
  it('should watch function tree executions', (done) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        const allRequiredTypesExist = requiredMessageTypes.every((type) =>
          messageTypes.includes(type)
        )

        assert.ok(
          allRequiredTypesExist,
          `Missing required message type(s). Required: ${requiredMessageTypes.join(', ')}, Actual: ${messageTypes.join(', ')}`
        )
      ...
      server.on('message', (event) => {
        ...
        switch (message.type) {
          ...
          case 'init':
            break
          default:
            messageTypes.push(message.type) // Add message type to array
            messages[message.type] = message
            break
        }
      })
