...
type Context<TProps = object> = IContext<TProps> & ProviderContext
type BranchContext<TPaths = object, TProps = object> = IBranchContext<
  TPaths,
  TProps
> &
  ProviderContext
...
describe('Fluent', () => {
  it('should return array', () => {
    ...
    const seq = Sequence((x) => x.action(action1)) as any as Array<any>
  ...
  it('should return paths correctly', () => {
    ...
    const seq = SequenceWithProps<Props>((x) =>
      x
        .action(action1)
        .branch(action3)
        .paths({
  ...
  describe('inference', () => {
    ...
    it('should infer sequence composition', () => {
      const seqA = SequenceWithProps<{ foo: string }, { bar: number }>((s) =>
