...
type MyBranchContext<TProps = {}, TPaths = {}> = IBranchContext<TProps, TPaths> & ProviderContext;

const Sequence = (<TOutput = {}>() => SequenceFactory<MyContext, TOutput>())();
const SequenceWithProps = (<TProps, TOutput = TProps>() => SequenceWithPropsFactory<MyContext, TProps, TOutput>())();
...
describe('Fluent', () => {
  ...
  it('should return paths correctly', () => {
    ...
    function action3(context: MyBranchContext<Props, Paths>) : PathResult {
