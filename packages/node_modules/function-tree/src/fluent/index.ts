...
export class SequenceBuilder<TContext = {}, TProps = {}> {
	...
	branch<TPaths, TOutput = {}>(action: ((input: TContext & IBranchContext<TPaths, TProps>) => TOutput | Promise<TOutput>)): {
	...
	branch<TPaths, TOutput = {}>(action: any): {
		paths: (paths: {[key in keyof TPaths]: (input: SequenceBuilder<TContext, TProps & TPaths[key]>) => SequenceBuilder<TContext, TProps & TPaths[key]> }) => SequenceBuilder<TContext, TProps & TOutput>
	} {
	...
	equals<TPaths extends { [key: string]: {}, otherwise: {} }, TValue>(callback: (input: TContext & IBranchContext<TPaths, TProps>) => TValue) {
