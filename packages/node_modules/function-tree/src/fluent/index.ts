import { Primitive, parallel } from '../../'
...
export class SequenceBuilder<TContext = object, TProps = object> {
  ...
  public branch<TPaths, TOutput = object>(
    action: (
  ...
  public when<TPaths extends { true: object; false: object }>(
  ...
  public debounce<TPaths extends { continue: object; discard: object }>(
    ms: number
  ): {
    paths: (paths: {
      [key in keyof TPaths]: (
    ...
    return this.branch<object, TPaths>(debounce(ms) as any)
  }

  public equals<
    TPaths extends { [key: string]: object; otherwise: object },
    TValue,
...
export function Sequence<Context, Output = object>(
  arg: (
    props: SequenceBuilder<Context, object>
  ) => SequenceBuilder<Context, Output>
): () => Output {
  return sequenceFactory<Context, object>(arg as any) as any
}
...
export function SequenceFactory<Context>() {
  function returned<Output = object>(
    arg: (
      props: SequenceBuilder<Context, object>
    ) => SequenceBuilder<Context, Output>
  ): () => Output {
