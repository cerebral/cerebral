...
describe('Fluent', () => {
    ...
    it('should return paths correctly', () => {
        ...
        var seq = SequenceWithProps((x) => x.action(action1).branch(action3).paths({
    ...
    describe('inference', () => {
        it('should infer props on next inline action', () => {
            ...
            var seq = Sequence((s) => s.action(action1).action(function action2({ props }) {
                props.foo = 'bar2';
            }));
        });
        it('should infer props on next action with required props', () => {
            ...
            var seq = Sequence((s) => s.action(action1).action(action2));
        });
