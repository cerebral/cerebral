...
export interface ModuleObjectDefinition<State, Signals, Computed> {
  state?: State
  signals?: Signals
  computed?: Computed
  reactions?: {
...
type ModuleFunction<State, Signals, Computed> = (
  module: { name: string; path: string; controller: ControllerClass }
) => ModuleObjectDefinition<State, Signals, Computed>

export type ModuleDefinition<State, Signals, Computed> =
  | ModuleObjectDefinition<State, Signals, Computed>
  | ModuleFunction<State, Signals, Computed>
...
export function Module<State = {}, Signals = {}, Computed = {}>(
  moduleDefinition: ModuleDefinition<State, Signals, Computed>
): ModuleClass
