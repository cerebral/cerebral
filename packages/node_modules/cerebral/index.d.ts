...
export default function App(rootModule: ModuleClass, config?: ControllerOptions): ControllerClass;
...
export function Reaction<T, K>(dependencies: T, cb: (dependencies: T & ComputedDependencies) => void): void;
