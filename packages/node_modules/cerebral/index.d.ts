...
import { Context as FunctionTreeContext, FunctionTree, Payload, Provider, Resolve, ResolveValue, Primitive, FunctionTreeExecutable } from 'function-tree'

export { sequence, parallel } from 'function-tree'
export type Sequence = FunctionTreeExecutable
...
export type ActionContext<ExtendedContext = { props: any }> = FunctionTreeContext<ExtendedContext> & ActionContextBase
...
export function Provider(provider: any, options: any): Provider
