...
export interface Resolve {
  isTag(arg: any, ...types: string[]): boolean
  isCompute(arg: any): boolean

  path(tag: Tag): string
  value<T>(computed: Computed<T> | T): T
  value<T>(tag: Tag<T> | T): T
  value(computed: Computed): any
  value(tag: Tag): any
}
...
export type ActionContext<P = any, U = {}> = ActionContextBase & {props: P} & U

export interface Action<P=any,T=void> extends FunctionTreeExecutable {
  (context: ActionContext<P>): T
}
