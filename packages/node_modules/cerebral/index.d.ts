...
export interface StateModel {
  ...
  get<T = any>(any?: string): T | undefined
  merge(path: any, {}): void
  pop(path: any): void
...
export function Compute<T0>(
  arg1: T0
): <K>(cb: (arg1: T0, get: ComputedGetter) => K) => Computed<K>
export function Compute<T0, T1>(
  arg1: T0,
  arg2: T1
): <K>(cb: (arg1: T0, arg2: T1, get: ComputedGetter) => K) => Computed<K>
export function Compute<T0, T1, T2>(
  arg1: T0,
  arg2: T1,
  arg3: T2
): <K>(
  cb: (arg1: T0, arg2: T1, arg3: T2, get: ComputedGetter) => K
) => Computed<K>
export function Compute<T0, T1, T2, T3>(
  arg1: T0,
  arg2: T1,
  arg3: T2,
  arg4: T3
): <K>(
  cb: (arg1: T0, arg2: T1, arg3: T2, arg4: T3, get: ComputedGetter) => K
) => Computed<K>
export function Compute<T0, T1, T2, T3, T4>(
  arg1: T0,
  arg2: T1,
  arg3: T2,
  arg4: T3,
