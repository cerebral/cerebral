...
export interface Resolve {
  ...
  path(tag: Tag): string
  value<T>(computed: Computed<T> | T, overrideProps?: any): T
  value<T>(tag: Tag<T> | T, overrideProps?: any): T
  value(computed: Computed, overrideProps?: any): any
  value(tag: Tag, overrideProps?: any): any
}
