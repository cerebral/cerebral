...
import { FunctionTree, Payload, Provider } from 'function-tree'
...
export interface ActionContext extends Payload {
...
export declare type Action = (context: ActionContext) => void
export declare type ActionFactory = (...args: any[]) => Action

export declare type Paths = {
  [path: string]: Chain
}

export declare type Executable = Action|Compute|Paths|Function[]
export declare type Chain = Executable[]
export declare type SignalChain = Chain

export declare type SignalsMap = { 
...
export declare type ModulesMap = { 
  [moduleName: string]: Module
}

export declare type Signal = (props?: any) => any
