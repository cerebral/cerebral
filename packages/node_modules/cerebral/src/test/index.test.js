/* eslint-env mocha */
import { Computed, Module, sequence } from '..'
import { state, props } from '../tags'
import { runCompute, runAction, runSequence, CerebralTest } from '.'
import assert from 'assert'

describe('test helpers', () => {
  describe('runCompute', () => {
    it('should test a Computed that gets state', () => {
      const testCompute = Computed(
        {
          foo: state`foo`,
        },
        ({ foo }) => foo
    ...
    it('should test a Computed that gets props', () => {
      const testCompute = Computed(
        {
          foo: props`foo`,
        },
