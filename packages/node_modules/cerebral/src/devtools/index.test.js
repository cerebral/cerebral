...
import { state, signals } from '../tags'
...
describe('Devtools', () => {
  ...
  it('should set component details and watch executions', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.deepEqual(toJSON(controller.devtools.debuggerWatchMap.foo), [
        { name: 'Test', executedCount: 0, type: 'View', id: 'Watch_0' },
      ])
      assert.deepEqual(toJSON(controller.devtools.debuggerWatchMap.bar), [
        { name: 'Test', executedCount: 0, type: 'View', id: 'Watch_0' },
      ])
      ...
      assert.deepEqual(messages.watchMap.data.map.foo, [
        { name: 'Test', executedCount: 0, type: 'View', id: 'Watch_0' },
      ])
      assert.deepEqual(messages.watchMap.data.map.bar, [
        { name: 'Test', executedCount: 0, type: 'View', id: 'Watch_0' },
      ])
      assert.deepEqual(messages.watchMap.data.updates, { ids: [] })
  ...
  it('should travel back in time', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.deepEqual(toJSON(controller.devtools.debuggerWatchMap.foo), [
        { name: 'Test', executedCount: 2, id: 'Watch_0', type: 'View' },
      ])
      assert.deepEqual(toJSON(controller.devtools.debuggerWatchMap.bar), [
        { name: 'Test', executedCount: 2, id: 'Watch_0', type: 'View' },
      ])
