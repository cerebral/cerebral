...
describe('Devtools', () => {
  ...
  it('should init correctly and work when debugger is open when app loads', (done) => {
    ...
    setTimeout(() => {
      assert.deepStrictEqual(messages, ['ping', 'init', 'watchMap'])
      ...
      assert.deepStrictEqual(controller.devtools.debuggerWatchMap, {})
      ...
      assert.deepStrictEqual(controller.devtools.controller, controller)
  ...
  it('should warn, try to reconnect to Debugger and send bulk message after connecting', (done) => {
    ...
    setTimeout(() => {
      assert.deepStrictEqual(messageTypes, ['bulk', 'watchMap'])

      assert.strictEqual(controller.devtools.isConnected, true)
      assert.deepStrictEqual(toJSON(controller.devtools.debuggerWatchMap.foo), [
        { name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' },
      ])
      assert.deepStrictEqual(toJSON(controller.devtools.debuggerWatchMap.bar), [
        { name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' },
      ])
      ...
      assert.deepStrictEqual(bulkMessagesTypes, [
        'executionStart',
        'execution',
        'execution',
        'executionEnd',
      ...
      assert.strictEqual(
        bulkMessages.executionStart[0].data.execution.name,
        'test'
      )
      ...
      assert.deepStrictEqual(
        bulkMessages.execution[0].data.execution.payload,
        {}
      )

      assert.ok(bulkMessages.execution[1].data.execution)
      assert.deepStrictEqual(
        bulkMessages.execution[1].data.execution.payload,
        {}
      )
      assert.strictEqual(
        bulkMessages.execution[1].data.execution.data.method,
        'set'
      )
      assert.deepStrictEqual(
        bulkMessages.execution[1].data.execution.data.args,
        [['foo'], 'foo']
      )
      assert.strictEqual(
      ...
      assert.strictEqual(
        bulkMessages.execution[1].data.execution.data.color,
        '#333'
      )
  ...
  it('should set component details and watch executions', (done) => {
    ...
    setTimeout(() => {
      assert.deepStrictEqual(messageTypes, ['watchMap'])
      assert.strictEqual(controller.devtools.isConnected, true)
      ...
      assert.deepStrictEqual(messages.watchMap.data.watchMap.foo, [
        { name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' },
      ])
      assert.deepStrictEqual(messages.watchMap.data.watchMap.bar, [
        { name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' },
      ])
      assert.deepStrictEqual(messages.watchMap.data.updates, [])
      ...
      setTimeout(() => {
        assert.deepStrictEqual(
          toJSON(controller.devtools.debuggerWatchMap.foo),
          [{ name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' }]
        )
        assert.deepStrictEqual(
          toJSON(controller.devtools.debuggerWatchMap.bar),
          [{ name: 'Test', executedCount: 1, type: 'View', id: 'Watch_0' }]
        )
        assert.strictEqual(controller.devtools.debuggerWatchMap.test, undefined)
        ...
        assert.strictEqual(
          messages.execution[1].data.execution.data.type,
          'mutation'
        )
        assert.strictEqual(
          messages.execution[1].data.execution.data.color,
          '#333'
        )
        ...
        assert.deepStrictEqual(messages.execution[2].data.execution.payload, {
          foo: 'bar',
        })
  ...
  it('should reset the state', (done) => {
    ...
    setTimeout(() => {
      ...
      assert.deepStrictEqual(controller.model.state, {
        foo: 'foo',
        bar: 'foo',
      })
      assert.deepStrictEqual(
    ...
    setTimeout(() => {
      ...
      assert.deepStrictEqual(controller.devtools.backlog, [])
      assert.deepStrictEqual(controller.devtools.mutations, [])
      assert.strictEqual(controller.devtools.debuggerWatchMap.test, undefined)
      mockServer.stop(done)
    }, 300)
  })
