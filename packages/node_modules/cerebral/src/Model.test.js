...
describe('Model', () => {
  ...
  it('should be able to flush changed paths', () => {
    ...
    assert.strictDeepEqual(model.flush(), [
      {
        path: ['foo', 'bar'],
  ...
  describe('SET', () => {
    it('should be able to set state', () => {
      ...
      model.set(['foo'], 'bar')
      assert.strictDeepEqual(model.get(), { foo: 'bar' })
    })
  })
  describe('TOGGLE', () => {
    it('should be able to toggle value', () => {
      ...
      model.toggle(['foo'])
      assert.strictDeepEqual(model.get(), { foo: false })
    })
  })
  describe('PUSH', () => {
    it('should be able to push to array', () => {
      ...
      model.push(['list'], 'bar')
      assert.strictDeepEqual(model.get(), { list: ['bar'] })
    })
  })
  describe('MERGE', () => {
    it('should be able to merge objects', () => {
      ...
      assert.strictDeepEqual(model.get(), { foo: { valA: 'foo', valB: 'bar' } })
    })
  ...
  describe('POP', () => {
    it('should be able to pop arrays', () => {
      ...
      model.pop(['list'])
      assert.strictDeepEqual(model.get(), { list: ['foo'] })
    })
  })
  describe('SHIFT', () => {
  ...
  describe('UNSHIFT', () => {
    it('should be able to unshift arrays', () => {
      ...
      assert.strictDeepEqual(model.get(), { list: ['bar', 'foo'] })
    })
  })
  describe('SPLICE', () => {
    it('should be able to splice arrays', () => {
      ...
      assert.strictDeepEqual(model.get(), { list: ['foo', 'bar2'] })
    })
  })
  describe('UNSET', () => {
    it('should be able to unset keys', () => {
      ...
      model.unset(['foo'])
      assert.strictDeepEqual(model.get(), {})
    })
  ...
  describe('CONCAT', () => {
    it('should be able to concat array', () => {
      ...
      assert.strictDeepEqual(model.get(), { foo: ['foo', 'bar'] })
    })
  })
  describe('INCREMENT', () => {
    it('should increment with default of 1', () => {
      ...
      model.increment(['foo'])
      assert.strictDeepEqual(model.get(), { foo: 4 })
    })
    it('should increment with given value', () => {
      ...
      assert.strictDeepEqual(model.get(), { foo: 5 })
    })
