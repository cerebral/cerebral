...
describe('utils', () => {
  describe('isSerializable', () => {
    ...
    it('should return false on classes', () => {
      class Test {}
      assert.strictEqual(utils.isSerializable(new Test()), false)
    })
    it('should return false on functions', () => {
      assert.strictEqual(utils.isSerializable(() => {}), false)
    })
    it('should return false on dates', () => {
      assert.strictEqual(utils.isSerializable(new Date()), false)
    })
    it('should return true if additionalTypes match', () => {
      assert.strictEqual(utils.isSerializable(new Date(), [Date]), true)
    })
    it('should check more than one additionalTypes', () => {
      assert.strictEqual(utils.isSerializable(new Date(), [RegExp, Date]), true)
    })
  })
  describe('ensurePath', () => {
    it('should always return array', () => {
      assert.deepStrictEqual(utils.ensurePath(null), [])
      assert.deepStrictEqual(utils.ensurePath(undefined), [])
      assert.deepStrictEqual(utils.ensurePath({}), [])
    })
  })
  describe('forceSerializable', () => {
    it('should return constructor name when it is not serializable', () => {
      class Test {}
      assert.strictEqual(utils.forceSerializable(new Test()).toJSON(), '[Test]')
    })
  })
