...
describe('utils', () => {
  ...
  describe('forceSerializable', () => {
    test('should return constructor name when it is not serializable', () => {
      class Test {}
      assert.equal(utils.forceSerializable(new Test()).toJSON(), '[Test]')
    })
  })
  describe('getWithPath', () => {
    test('should throw when path is not valid for given object', () => {
      const obj = {
        form: 'Ben',
      }
      assert.throws(() => {
  ...
  describe('createResolver', () => {
    test('should throw when argument is not a Tag', () => {
  ...
  describe('dependencyMatch', () => {
    test('should match dependencies', () => {
      assert.equal(
    ...
    test('should match nested dependencies', () => {
      assert.ok(
        utils.dependencyMatch(
          [
            {
    ...
    test('should match child interest dependencies', () => {
      assert.equal(
        utils.dependencyMatch(
          [
            {
