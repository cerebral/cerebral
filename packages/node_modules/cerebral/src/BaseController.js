...
class BaseController extends FunctionTree {
  constructor(config) {
    ...
    this.contextProviders = [ControllerProvider(this)]
      ...
      .concat(this.model.StateProvider(this.devtools))
  ...
  */
  ...
  addModule(path, module) {
    ...
    const newModule = new Module(this, ensurePath(path), module)
    parentModule.modules[moduleKey] = newModule

    if (newModule.provider) {
      this.contextProviders.push(newModule.provider)
    }
