...
describe('operator.merge', () => {
  test('should merge value in model', () => {
  ...
  test('should merge value from props in model', () => {
    const rootModule = Module({
      state: {
        users: {
          john: 'John Difool',
  ...
  test('should create object if no value', () => {
    const rootModule = Module({
      state: {},
      signals: {
