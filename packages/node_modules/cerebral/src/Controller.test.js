...
describe('Controller', () => {
  ...
  it('should throw error when signals are grabbed before initialized', () => {
    assert.throws(() => {
      const testModule = Module(({ controller }) => {
  ...
  it('should pass instance of controller and path info on functions module instantiation', () => {
    const barModule = Module(({ controller, path, name }) => {
  ...
  it('should throw when grabbing a non existing signal', () => {
    const rootModule = Module({})
    const controller = Controller(rootModule)
    assert.throws(() => {
  ...
  it('should be able error catchers to modules', done => {
    const rootModule = Module({
      state: {},
      signals: {
        test: [
