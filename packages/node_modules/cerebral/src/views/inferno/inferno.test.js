...
describe('Inferno', () => {
  ...
  describe('container', () => {
      ...
      assert.throws(
        ...
        err => {
          if (err instanceof Error) {
            return (
              err.message ===
              'Cerebral - Can not find controller, did you remember to use the Container component? Read more at: http://cerebraljs.com/docs/introduction/view_type.html#inferno'
            )
          }
        }
      )
    ...
    it('should be able to unregister component from container after unmounting component', () => {
      ...
      assert.equal(tree._lastInput.children._isUnmounting, undefined)
      assert.equal($('div').innerHTML, 'bar')
      mount(null)
      assert.equal(tree._lastInput.children._isUnmounting, true)
      assert.deepEqual(
