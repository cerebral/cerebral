...
describe('Module', () => {
  test('should instantiate with initial state', () => {
  ...
  test('should instantiate with signals', () => {
    const rootModule = Module({
      signals: {
        bar: [],
      },
  ...
  test('should instantiate with signals defined as sequence', () => {
    const rootModule = Module({
      signals: {
        bar: sequence('bar', []),
      },
  ...
  test('should run signals with providers', () => {
    const rootModule = Module({
      modules: {
        foo: Module({
          signals: {
  ...
  test('should be able to define signals with signal property', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should be able to define module with catch property and custom errors', () => {
  ...
  test('should be able to define module with catch property using CerebralError', () => {
    const catchError = ({ props, state }) =>
      state.set('foo', props.error.message)
    const rootModule = Module({
      state: {
  ...
  test('should throw when no matching custom catch type', () => {
    class TestError {}
    const catchError = ({ props, state }) =>
      state.set('foo', props.error.message)
    const rootModule = Module({
  ...
  test('should throw when signal is not set properly', () => {
    assert.throws(() => {
      Controller(
        Module({
          signals: {
