...
class View {
  constructor({
    ...
    this.dependencyMap = this.getDependencyMap(props)
    this.computed = this.getComputed(props)
  }
  /*
  ...
  getComputed(props) {
    ...
    return Object.keys(this.dependencies).reduce((computeds, key) => {
      if (
        ...
        computeds[key] = this.dependencies[key].getValue(getters).clone()
  ...
  */
  getProps(getters, props = {}, includeProps = true) {
    const dependenciesProps = Object.keys(this.dependencies).reduce(
      ...
      {
        get: this.createDynamicGetter(props, getters),
      }
    )
