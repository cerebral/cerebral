  ...
  getComputed(props) {
    ...
    return Object.keys(this.dependencies).reduce((computed, key) => {
      if (
        ...
        this.dependencies[key].getValue(getters) instanceof Compute
      ) {
        ...
        computed[key] = {
          ...
          unsubscribe: attachedComputed.subscribe(this, this.updateComponent),
        }
      }
  ...
  getProps(getters, props = {}, includeProps = true) {
    const dependenciesProps = Object.keys(this.dependencies).reduce(
      (currentProps, key) => {
        ...
        currentProps[key] =
          value instanceof Compute ? value.getValue(props) : value
