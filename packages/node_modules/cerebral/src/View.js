...
class View {
  constructor({
    ...
    this.computedSubscriptions = this.subscribeToComputeds(props)
  }
  /*
    ...
    const dependenciesProps = Object.keys(this.dependencies).reduce(
      (currentProps, key) => {
        ...
        if (tag.type === 'computed') {
          currentProps[key] = tag.getValue(getters).getValue(props)
        } else {
