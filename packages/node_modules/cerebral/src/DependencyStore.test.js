...
describe('DependencyStore', () => {
  ...
  test('should return all unique components', () => {
    const depsStore = new DependencyStore()
    const componentA = {}
    const componentB = {}
  ...
  describe('dependency matching', () => {
    test('should return exact matches', () => {
      const depsStore = new DependencyStore()
      const component = {}
      depsStore.addEntity(component, { foo: true })
      assert.deepEqual(
    ...
    test('should return matches on immediate and all interest', () => {
      const depsStore = new DependencyStore()
      const component = {}
    ...
    test('should return matches on immediate', () => {
      const depsStore = new DependencyStore()
      const component = {}
      depsStore.addEntity(component, { 'foo.*': true })
      assert.deepEqual(
    ...
    test('should return matches on all', () => {
      const depsStore = new DependencyStore()
      const component = {}
      depsStore.addEntity(component, { 'foo.**': true })
      assert.deepEqual(
    ...
    test('should return matches on all forceChildPathUpdates', () => {
      const depsStore = new DependencyStore()
      const component = {}
    ...
    test('should return matches on all forceChildPathUpdates with interest', () => {
      const depsStore = new DependencyStore()
      const component = {}
    ...
    test('should handle not having interest conflicts', () => {
      const depsStore = new DependencyStore()
      const componentA = {}
      const componentB = {}
