...
describe('GET', () => {
  it('should be able to GET state', () => {
    const rootModule = {
      ...
      sequences: {
        foo: [({ get }) => assert.strictDeepEqual(get(state`foo`), 'bar')],
      },
    }
  ...
  it('should be able to GET module state', () => {
    const rootModule = {
      ...
      sequences: {
        foo: [({ get }) => assert.strictDeepEqual(get(moduleState`foo`), 'bar')],
      },
    }
    const controller = App(rootModule)
    controller.getSequence('foo')()
  ...
  it('should be able to GET props', () => {
    const rootModule = {
      sequences: {
        foo: [({ get }) => assert.strictDeepEqual(get(props`foo`), 'bar')],
      },
    }
    const controller = App(rootModule)
    controller.getSequence('foo')({
  ...
  it('should be able to GET computed', () => {
    const rootModule = {
      ...
      sequences: {
        foo: [({ get }) => assert.strictDeepEqual(get(state`fooComputed`), 'bar')],
      },
    }
    const controller = App(rootModule)
    controller.getSequence('foo')()
