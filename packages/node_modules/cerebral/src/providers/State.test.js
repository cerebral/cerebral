...
describe('State', () => {
  ...
  test('should be able to SET state with an array in the path', () => {
    const rootModule = Module({
      state: { foo: ['bar'] },
      signals: {
  ...
  test('should be able to PUSH state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo'],
      },
  ...
  test('should be able to MERGE state', () => {
    const rootModule = Module({
      state: {
        foo: { foo: 'bar' },
      },
  ...
  test('should be able to POP state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo', 'bar'],
      },
  ...
  test('should be able to SHIFT state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo', 'bar'],
      },
  ...
  test('should be able to UNSHIFT state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo'],
      },
  ...
  test('should be able to SPLICE state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo'],
      },
  ...
  test('should be able to UNSET state', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should be able to CONCAT state', () => {
    const rootModule = Module({
      state: {
        foo: ['foo'],
      },
  ...
  test('should provide a descriptive error when passing invalid value to state', () => {
    const rootModule = Module({
      state: {
        foo: '',
      },
