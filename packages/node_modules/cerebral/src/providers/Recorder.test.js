...
describe('Recorder', () => {
  ...
  test('should allow option to extract specific paths as starting point', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const rootModule = Module({
      state: {
  ...
  test('should prevent further signal execution', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const rootModule = Module({
      state: {
  ...
  test('should emit flush event when playing back, on subsequente changes and as last event', (done) => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const rootModule = Module({
      state: {
  ...
  test('should be able to pause and continue playback', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const now = Date.now()
    const recording = {
  ...
  test('should add external events', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const rootModule = Module({
      state: {
  ...
  test('should work with devtools', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const now = Date.now()
    const recording = {
  ...
  test('should throw an error when sending play signal while already playing or recording', () => {
    const timeout = timeoutMock()
    const RecorderProvider = require('./Recorder').default
    const now = Date.now()
    const recording = {
