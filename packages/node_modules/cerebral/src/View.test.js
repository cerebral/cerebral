...
describe('View', () => {
  ...
  it('should be able to dynamically define signals', () => {
    const rootModule = Module({
      ...
      signals: {
        foo: [({ mutation }) => mutation.set(state`test`, 'fooSignal')],
      },
    })
    const controller = Controller(rootModule)
    const view = new View({
  ...
  it('should update tags', () => {
    ...
    const rootModule = Module({
      ...
      signals: {
        test: [
          ({ mutation }) => {
            mutation.set(state`currentItem`, '1')
          },
        ],
      },
    })
  ...
  it('should rerender on state update', () => {
    ...
    const rootModule = Module({
      ...
      signals: {
        methodCalled: [({ mutation }) => mutation.set(state`foo`, 'bar2')],
      },
    })
    const controller = Controller(rootModule)
  ...
  it('should render only ones where multiple state changes', () => {
    const rootModule = Module({
      ...
      signals: {
        test: [
          ({ mutation }) => {
            mutation.set(state`foo`, 'bar2')
            mutation.set(state`bar`, 'foo2')
          },
        ],
      },
    })
  ...
  it('should rerender on parent dep replacement', () => {
    ...
    const rootModule = Module({
      ...
      signals: {
        methodCalled: [
          ({ mutation }) => mutation.set(state`foo`, { bar: 'baz2' }),
        ],
      },
    })
    const controller = Controller(rootModule)
  ...
  describe('STRICT render update', () => {
    ...
    it('should be able to override immediate child interest', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          methodCalled: [
            ({ mutation }) => mutation.set(state`foo.0.bar`, 'baz2'),
          ],
        },
      })
      const controller = Controller(rootModule)
    ...
    it('should by default update when nested children update', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          methodCalled: [
            ({ mutation }) => mutation.set(state`foo.bar.baz`, 'value2'),
          ],
        },
      })
      const controller = Controller(rootModule)
    ...
    it('should by default update when nested children update with array', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          methodCalled: [
            ({ mutation }) => mutation.set(state`foo.0.bar`, 'value2'),
          ],
        },
      })
      const controller = Controller(rootModule)
  ...
  describe('Compute', () => {
    ...
    it('should update dependency map when Compute is rerun', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          changeState: [
            ({ mutation }) => mutation.set(state`map.1`, { awesome: true }),
          ],
          changeState2: [
            ({ mutation }) => mutation.set(state`map.1.awesome`, false),
          ],
        },
      })
      const controller = Controller(rootModule)
    ...
    it('should handle complex state changes', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          changeState: [
            ({ mutation }) => mutation.push(state`user.projects`, '2'),
          ],
        },
      })
      const controller = Controller(rootModule)
    ...
    it('should handle strict deps', () => {
      ...
      const rootModule = Module({
        ...
        signals: {
          changeState: [
            ({ mutation }) => mutation.set(state`projects.1.title`, 'woop'),
          ],
        },
      })
      const controller = Controller(rootModule)
  ...
  it('should handle props updating state deps', () => {
    const rootModule = Module({
      ...
      signals: {
        changeState: [({ mutation }) => mutation.set(state`bar`, 'baz2')],
      },
    })
    const controller = Controller(rootModule)
    const view = new View({
  ...
  it('should handle props composition updating value', () => {
    const rootModule = Module({
      ...
      signals: {
        changeState: [
          ({ mutation }) => {
            mutation.set(state`field.value`, 'foo')
            mutation.merge(state`field`, { mip: 'mop' })
          },
        ],
      },
    })
