...
describe('View', () => {
  test('should throw an error if no dependencies provided', () => {
    assert.throws(
      () => {
        new View({
  ...
  test('should throw an error if dependency is a function', () => {
    assert.throws(
      () => {
        new View({
          dependencies: () => {},
  ...
  test('should throw an error if dependency item is not tags or Compute', () => {
  ...
  test('should return undefined when signal is not defined', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should warn if component has more dependencies than devtools configuration', () => {
    let warnCount = 0
  ...
  test('should be able to extract state', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should be able to extract signals', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should be able to dynamically define signals', () => {
    const rootModule = Module({
      state: {
        test: '',
      },
  ...
  test('should be able to adjust props with function (mergeProps)', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
      },
  ...
  test('should handle complex dependencies when mounting', () => {
  ...
  test('should update devtools components map and add entity to controller dependency store when mounting', () => {
  ...
  test('should update devtools components map and remove entity from controller dependency store when unmounting', () => {
    let devtoolsUpdateComponentsMapCalled = 0
  ...
  test('should update on props change', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
        bar: 'baz',
  ...
  test('should not update when there is no props change', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
        bar: 'baz',
  ...
  test('should rerender on state update', () => {
    let renderCount = 0
    const rootModule = Module({
      state: {
        foo: 'bar',
  ...
  test('should render only ones where multiple state changes', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
        bar: 'foo',
  ...
  test('should rerender when controller flush method called with force option', () => {
    let renderCount = 0
    const rootModule = Module({
      state: {
        foo: 'bar',
  ...
  test('should rerender on parent dep replacement', () => {
    let renderCount = 0
    const rootModule = Module({
      state: {
        foo: {
  ...
  test('should only rerender affected components', () => {
  ...
  describe('STRICT render update', () => {
    test('should update when parent path changes', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          foo: {
    ...
    test('should be able to override immediate child interest', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          foo: [
    ...
    test('should by default update when nested children update', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          foo: {
    ...
    test('should update when undefined path becoming defined', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {},
        signals: {
    ...
    test('should update when undefined path becoming defined deeply', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {},
        signals: {
    ...
    test('should by default update when nested children update with array', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          foo: [
    ...
    test('should by default update when nested children update using COMPUTE', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          foo: {
  ...
  describe('Compute', () => {
    test('should allow use of Compute as state dependency and access props', () => {
      const rootModule = Module({})
      const controller = Controller(rootModule)
      const view = new View({
        dependencies: {
    ...
    test('should have access to state through state argument', () => {
      const rootModule = Module({
        state: {
          foo: 'bar',
        },
    ...
    test('should update dependency map when Compute is rerun', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          map: {},
    ...
    test('should handle strict deps', () => {
      let renderCount = 0
      const rootModule = Module({
        state: {
          user: {
  ...
  test('should handle props updating state deps', () => {
    const rootModule = Module({
      state: {
        foo: 'bar',
        bar: 'baz',
  ...
  test('should handle props composition updating value', () => {
    const rootModule = Module({
      state: {
        field: {
          value: '',
  ...
  test('should warn if prop is from the Cerebral state tree when initializing', () => {
    let warnCount = 0
    const originWarn = console.warn
    console.warn = function(...args) {
      warnCount++
  ...
  test('should warn if prop is from the Cerebral state tree when updating props', () => {
    let warnCount = 0
    const originWarn = console.warn
    console.warn = function(...args) {
      warnCount++
