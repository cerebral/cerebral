...
export declare function extractModuleProp(
  module: InstantiatedModuleObjectDefinition,
  key: string,
  cb: (propValue: any, moduleObject: InstantiatedModuleObjectDefinition) => any
): any
...
export declare function getChangedProps(prevProps: any, newProps: any): string[]
