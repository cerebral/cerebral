...
describe('React', () => {
  ...
  describe('connect', () => {
    ...
    it('should warn if component has more dependencies than devtools configuration', () => {
      ...
      assert.equal(
        TestUtils.findRenderedComponentWithType(tree, TestComponent)
          ._hasWarnedBigComponent,
        true
      )
    ...
    it('should throw an error if no container component provided', () => {
      ...
      assert.throws(
        ...
        Error,
        'Cerebral - Can not find Cerebral controller, did you remember to use the Container component? Read more at: http://www.cerebraljs.com/documentation/cerebral-view-react'
      )
    })
    ...
    it('should throw an error if there is no path or computed assigned to prop', () => {
      ...
      assert.throws(
        ...
        Error,
        'Cerebral - There is no path or computed assigned to prop foo'
      )
    })
