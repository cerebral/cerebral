...
function onChildAddedFactory (pathTemplate, signalTemplate, options = {}) {
  function onChildAdded ({firebase, state, input, controller}) {
    ...
    firebase.onChildAdded(firebasePath, signal, convertObjectWithTemplates(options, tagGetters))
  }
